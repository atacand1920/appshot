...
import { templates, getTemplate, applyTemplateToConfig, getTemplateCaptionSuggestions, getTemplateCategories, resolveTemplateId } from '../templates/registry.js';
import { validateTemplateId, sanitizeCaption, validateJson } from '../utils/validation.js';
 ...
 */
async function addCaptions(config, singleCaption, captionsJson) {

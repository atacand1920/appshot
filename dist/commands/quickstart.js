...
import { getTemplate, getTemplateCaptionSuggestions, resolveTemplateId, applyTemplateToConfig } from '../templates/registry.js';
import { validateTemplateId, sanitizeCaption, validateDeviceArray } from '../utils/validation.js';
 ...
 */
async function initializeProject(devices) {
    const dirs = [
        '.appshot',
        '.appshot/captions',
 ...
 */
async function applyTemplate(templateId, devices) {
    const resolved = resolveTemplateId(templateId);
 ...
 */
async function setupCaptions(devices, mainCaption, templateId) {

        ...
        try {
            ...
            if (!autoFrameAnswer.autoFrame) {
                ...
                const deviceFrames = frameRegistry.filter(f => {
                    ...
                    if (device === 'iphone')
                        return frameName.includes('iphone');
                    if (device === 'ipad')
                        return frameName.includes('ipad');
                    if (device === 'mac')
                        return frameName.includes('mac') || frameName.includes('imac');
                    if (device === 'watch')
                        return frameName.includes('watch');
                    return false;
                });
            ...
            if (captionAnswer.customizeCaption) {
                ...
                if (stylingAnswer.customizeStyling) {
                    ...
                    const sideMarginAnswer = await inquirer.prompt([{
                            ...
                            default: (v1Config.caption.background && v1Config.caption.background.sideMargin) || 30,
                    ...
                    if (!borderAnswer.addBorder) {
                        ...
                        if (radiusOnlyAnswer.radius === 'custom') {
                            ...
                            chosenRadius = radiusOnlyAnswer.radius;
                        }
                ...
                if (boxAnswer.customizeBox) {
                    ...
                    const valignAnswer = await inquirer.prompt([{
                            ...
                            default: (v1Config.caption.box && v1Config.caption.box.verticalAlign) || 'center'
                        }]);
                    ...
                    if (!autoSizeAnswer.autoSize) {
                        const minHeightAnswer = await inquirer.prompt([{
                                ...
                                default: (v1Config.caption.box && v1Config.caption.box.minHeight) || 100,
                        ...
                        const maxHeightAnswer = await inquirer.prompt([{
                                ...
                                default: (v1Config.caption.box && v1Config.caption.box.maxHeight) || 500,
                    ...
                    const marginTopAnswer = await inquirer.prompt([{
                            ...
                            default: (v1Config.caption.box && v1Config.caption.box.marginTop) || 0,
                    ...
                    const marginBottomAnswer = await inquirer.prompt([{
                            ...
                            default: (v1Config.caption.box && v1Config.caption.box.marginBottom) || 0,
                            validate: (v) => (v !== undefined && v >= 0 && v <= 400) || 'Enter a value between 0 and 400'
                        }]);
...
function formatFramePosition(position) {
...
async function runV2StyleFlow(config) {
    console.log(pc.bold('\n🎨 v2 Layout Style'));
    ...
    config.layout = layoutAnswer.layout;

 ...
 */
export function sanitizeDevices(devices) {
 ...
 */
export function sanitizeLanguages(langs) {
    // Bounds checking - prevent DoS
 ...
 * Sanitize file paths
 */
export function sanitizePath(outputPath) {
    // Bounds checking - prevent DoS
...
export function validateTemplateId(templateId) {
    ...
    return templates.some((t) => t.id === resolved.id);
}
/**
 * Sanitize and validate device array
 */
export function validateDeviceArray(devices) {
    // Limit array size

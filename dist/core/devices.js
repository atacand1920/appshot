 ...
 */
export function detectDeviceTypeFromDimensions(width, height) {
    if (!width || !height)
        return null;
 ...
 */
export async function autoSelectFrame(screenshotPath, framesDir, deviceType, preferredFrame, dryRun = false) {
    try {

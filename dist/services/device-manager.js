...
export class DeviceManager {
    ...
    detectDeviceCategory(deviceName) {
        // Check mapping first
...
class SimulatorService {
    ...
    async waitForBoot(deviceId, maxWait = 30000) {
